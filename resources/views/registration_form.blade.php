...
<div class="container">
    <div class="flex flex-col justify-center items-center" style="min-height:70vh;">
        ...
        <div class="relative flex flex-col text-gray-700 bg-transparent shadow-none rounded-xl bg-clip-border">
            ...
            <form method="post" action="{{route('register')}}" class="max-w-screen-lg mt-8 mb-2 ">
                @csrf
             <div class="grid grid-cols-2 gap-4">
                <div class="w-72">
                    ...
                    <span class="test-sm text-red-500">{{$errors->first('name')}}</span>
                    @endif
                  ...
                  <div class="w-72">
                    ...
                    <span class="test-sm text-red-500">{{$errors->first('password_confirmation')}}</span>
                    @endif
                  </div>                                                                                                           
             </div>
              <button
